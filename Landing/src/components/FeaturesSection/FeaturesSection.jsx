...
const features = [
    {
        ...
        description: 'Advanced OCR extracts medicine names, dosages, and schedules instantly from handwritten medical prescriptions.',
        icon: (
    ...
    {
        title: 'Pharma AI Disease Prediction',
        description: 'Use machine learning to identify possible future disease patterns and support early planning.',
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
